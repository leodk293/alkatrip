...
export default function SwimmingPool() {
  ...
  const maxIndex = Math.max(0, swimming_pools.length - cardsToShow);
  ...
  return (
    <div className="mt-[7rem] flex flex-col items-center gap-5">
      <h1 className="text-3xl font-bold">Piscines avec déjeuner</h1>
      ...
      <div className="relative w-full max-w-10xl mx-auto px-4">
        ...
        <div className="relative overflow-hidden rounded-lg">
          <div
            ...
            style={{
              ...
              width: `${swimming_pools.length * (100 / cardsToShow)}%`,
            }}
          >
            {swimming_pools.map((element, index) => (
              <div
                key={nanoid(10)}
                className="px-2"
                style={{
        ...
        <button
          ...
          aria-label="Previous swimming pool"
        >
          <svg
            className="w-6 h-6"
            fill="none"
